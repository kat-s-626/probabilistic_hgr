...
################################################################################
 ...
 ./compute_posterior_monroe.sh benchmarks/monroe-100/00-domain/domain.hddl benchmarks/monroe-100/01-problems/p-0001-clear-road-wreck.hddl benchmarks/monroe-100/02-solutions/solution-0001.txt 1 5
...
if [ $# -lt 5 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  ./compute_posterior.sh benchmarks/kitchen-100/00-domain/domain_explicit_hypotheses.hddl /Users/katherinei/Library/CloudStorage/OneDrive-TheUniversityofMelbourne/Documents/GitHub/goal_rec_htn/benchmarks/kitchen-100/01-problems/p-0003-kitchen.hddl benchmarks/kitchen-100/02-solutions/p-0003-kitchen.txt 5 5"
    exit 1
fi
...
for iteration in $(seq 1 $K_ITERATIONS); do
    ...
    # Use pgrfo (fully observable) since we're working with observed action sequences
    "./htnPrefixEncoding" pgrfo "${ITER_PREFIX}_grounded.psas" \
